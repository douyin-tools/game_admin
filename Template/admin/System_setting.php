...
<div class="page-container">
	<form class="form form-horizontal"  method="post" action="{:url('System/settingdo')}" confirm="确定吗修改系统配置吗？" enctype="multipart/form-data">
		<div id="tab-system" class="HuiTab">
			...
			<div class="tabCon">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">前台路径 如D:/www/web</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="info[web_path]" placeholder="如D:/www/web" value="{$setlist.web_path}" class="input-text"> <a class="btn green"  target="_blank"href="{:url('system/del_huancun',['type'=>'web_path'])}">清除前台缓存</a>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">后台路径 如D:/www/admin</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="info[admin_path]" placeholder="如D:/www/admin" value="{$setlist.admin_path}" class="input-text"><a class="btn green"  target="_blank" href="{:url('system/del_huancun',['type'=>'admin_path'])}">清除后台缓存</a>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">开奖路径 如D:/www/kj</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="info[kj_path]" placeholder="如D:/www/kj" value="{$setlist.kj_path}" class="input-text"><a class="btn green"   target="_blank"href="{:url('system/del_huancun',['type'=>'kj_path'])}">清除开奖器缓存</a>
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">是否启用真人视讯：</label>
					<div class="formControls col-xs-8 col-sm-9">
                        <label><input type="radio" name="info[switch_ng]" value="1" {if condition="$setlist['switch_ng'] eq 1"}checked{/if}>开 </label>&nbsp;&nbsp;
                        <label><input type="radio" name="info[switch_ng]" value="0" {if condition="$setlist['switch_ng'] eq 0"}checked{/if}>关 </label>
					</div>
				</div>
					<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">真人开户地址</label>
					<div class="formControls col-xs-8 col-sm-9">http://admin.ng-api.com/merchant/register?token=4de84a86aeecc1c68aeb081255fc1f4a<a class="btn green"   target="_blank"href="http://admin.ng-api.com/merchant/register?token=4de84a86aeecc1c68aeb081255fc1f4a">去开户</a>
					</div>
					
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">&#78;&#71;&#25509;&#21475;&#97;&#112;&#105;&#95;&#97;&#99;&#99;&#111;&#117;&#110;&#116;</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="info[api_account]" placeholder="api_account" value="{$setlist.api_account}" class="input-text">
					</div>
					
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">&#78;&#71;&#25509;&#21475;&#115;&#105;&#103;&#110;&#95;&#107;&#101;&#121;</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="info[sign_key]" placeholder="sign_key" value="{$setlist.sign_key}" class="input-text"><span style="color:red;">&#27880;&#24847;&#65306;&#30495;&#20154;&#35270;&#35759;&#24179;&#21488;&#30340;&#29992;&#25143;&#21517;&#20026;&#107;&#101;&#121;&#21518;&#52;&#20301;&#43;&#29992;&#25143;&#21517; {if condition="$setlist['sign_key'] neq ''"}&#24403;&#21069;&#30495;&#20154;&#24179;&#21488;&#29992;&#25143;&#21517;&#20026;：{:substr($setlist['sign_key'],-4)}&#20250;&#21592;&#21517;{/if}<br/><H5>&#x989d;&#x5ea6;&#x8f6c;&#x6362;&#x540e;&#x9700;&#x8981;&#x91cd;&#x65b0;&#x4ece;&#x89c6;&#x8baf;&#x9875;&#x9762;&#x8fdb;&#x5165;&#x6e38;&#x620f;&#x624d;&#x80fd;&#x663e;&#x793a;&#x6700;&#x65b0;&#x4f59;&#x989d;&#x3010;QQ14014011&#x3011;</h3></span>
					</div>
