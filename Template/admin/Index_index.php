...
<div class="layui-layout layui-layout-admin okadmin blue_theme">
    ...
    <div class="layui-header okadmin-header">
        ...
        <style>
            ...
            .warning-red {
                color:#fc2;background: red;
            }
            .warning-fc2 {
                color:red;background: #fc2;
            }
        </style>
        <ul class="layui-nav layui-layout-left warning-ul" style="margin-left: 100px;">
...
<script type="text/javascript">
    ...
    window.setInterval(function () {
        if (colorState) {
            $('.warning-msg').addClass('warning-fc2');
            $('.warning-msg').removeClass('warning-red');
        } else {
            $('.warning-msg').addClass('warning-red');
            $('.warning-msg').removeClass('warning-fc2');
        }
